...
else{ $sql = 'insert into bottomform_query (Name,Email,country_code,country_name,Number,Services,Form_name,Message,cip,locationURL)  
  values ("'.$_REQUEST['Name'].'","'.$_REQUEST['Email'].'","'.$_REQUEST['pc'].'","'.$_REQUEST['ctry'].'","'.$_REQUEST['Number'].'","'.$_REQUEST['Services'].'","'.$_REQUEST['Form_name'].'","'.$_REQUEST['Message'].'","'.$_REQUEST['cip'].'","'.$_REQUEST['locationURL'].'")';
