...
class magezix_post_grid extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Grid', 'magezix-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'layout_style',
			[
				'label' => esc_html__( 'Grid Style', 'magezix-core' ),
				'type' => Controls_Manager::SELECT2,
				'default' => 'style_1',
				'options' => [
					'style_1'  => esc_html__( 'Grid Style 1', 'magezix-core' ),
					'style_2'  => esc_html__( 'Grid Style 2', 'magezix-core' ),
				],
			]
		);
        $this->add_control(
	...
	<?php 
		if('style_1' == $settings['layout_style']){
			require dirname( __FILE__ ) . '/views/grid-style-1.php';
		}elseif('style_2' == $settings['layout_style']){
			require dirname( __FILE__ ) . '/views/grid-style-2.php';
		}else{
			require dirname( __FILE__ ) . '/views/grid-style-1.php';
		}
	?>
...
Plugin::instance()->widgets_manager->register( new magezix_post_grid() );