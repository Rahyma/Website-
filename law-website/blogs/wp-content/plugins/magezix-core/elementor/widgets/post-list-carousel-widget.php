...
class magezix_post_list_carosule extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post List Carousel', 'magezix-core' );
	}
        ...
        ?>
            <div class="carousel-post__item tx-post pos-rel ul_li">
                ...
                <div class="post-content">
                    <h3 class="post-title fs-17"><a href="<?php the_permalink();?>"><?php echo esc_html($title);?></a></h3>
...
Plugin::instance()->widgets_manager->register( new magezix_post_list_carosule() );