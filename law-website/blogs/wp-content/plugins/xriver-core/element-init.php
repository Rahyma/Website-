...
if(site_url()=="https://themexriver.com/wp/hoom" OR site_url() == 'http://localhost:10348') {
...
final class ElementHelper {
	...
	public function __construct() {
		...
		add_action( 'elementor/frontend/after_enqueue_scripts', function() {
			...
			wp_enqueue_script( 'elh-element-helper', XRIVER_CORE_URL . 'assets/js/elh-element.js', [ 'jquery' ], ELH_VERSION, true );
	...
	public function init() {
		...
		// Included all files.
		require_once XRIVER_CORE_DIR . 'inc/autoload.php';
		require_once XRIVER_CORE_DIR . 'inc/helper-functions.php';
	...
	public function add_elementor_widget_categories( $elements_manager ) {
		...
		$categories['element-helper'] =
			[
				'title' => __( 'Xriver CORE', 'element-helper' ),
				'icon'  => 'fa fa-plug'
			];
