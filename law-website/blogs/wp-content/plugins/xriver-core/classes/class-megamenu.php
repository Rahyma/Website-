...
require_once XRIVER_CORE_DIR . 'classes/class-megamenu-walker.php';

class Alpha_MegaMenu_Register {
    /**
    ...
    function init() {
        ...
        if ( $this->enable_megamenu === true ) {
            $labels = [
                'name'                  => _x( 'Mega Menus', 'Post Type General Name', XRIVER_CORE_TEXT_DOMAIN ),
                'singular_name'         => _x( 'Mega Menu', 'Post Type Singular Name', XRIVER_CORE_TEXT_DOMAIN ),
                'menu_name'             => __( 'Mega Menus', XRIVER_CORE_TEXT_DOMAIN ),
                'name_admin_bar'        => __( 'Mega Menus', XRIVER_CORE_TEXT_DOMAIN ),
                'archives'              => __( 'Item Archives', XRIVER_CORE_TEXT_DOMAIN ),
                'parent_item_colon'     => __( 'Parent Item:', XRIVER_CORE_TEXT_DOMAIN ),
                'all_items'             => __( 'All Items', XRIVER_CORE_TEXT_DOMAIN ),
                'add_new_item'          => __( 'Add New Mega Menu', XRIVER_CORE_TEXT_DOMAIN ),
                'add_new'               => __( 'Add New', XRIVER_CORE_TEXT_DOMAIN ),
                'new_item'              => __( 'New Mega Menu', XRIVER_CORE_TEXT_DOMAIN ),
                'edit_item'             => __( 'Edit Mega Menu', XRIVER_CORE_TEXT_DOMAIN ),
                'update_item'           => __( 'Update Mega Menu', XRIVER_CORE_TEXT_DOMAIN ),
                'view_item'             => __( 'View Mega Menu', XRIVER_CORE_TEXT_DOMAIN ),
                'search_items'          => __( 'Search Mega Menu', XRIVER_CORE_TEXT_DOMAIN ),
                'not_found'             => __( 'Not found', XRIVER_CORE_TEXT_DOMAIN ),
                'not_found_in_trash'    => __( 'Not found in Trash', XRIVER_CORE_TEXT_DOMAIN ),
                'featured_image'        => __( 'Featured Image', XRIVER_CORE_TEXT_DOMAIN ),
                'set_featured_image'    => __( 'Set featured image', XRIVER_CORE_TEXT_DOMAIN ),
                'remove_featured_image' => __( 'Remove featured image', XRIVER_CORE_TEXT_DOMAIN ),
                'use_featured_image'    => __( 'Use as featured image', XRIVER_CORE_TEXT_DOMAIN ),
                'insert_into_item'      => __( 'Insert into item', XRIVER_CORE_TEXT_DOMAIN ),
                'uploaded_to_this_item' => __( 'Uploaded to this item', XRIVER_CORE_TEXT_DOMAIN ),
                'items_list'            => __( 'Items list', XRIVER_CORE_TEXT_DOMAIN ),
                'items_list_navigation' => __( 'Items list navigation', XRIVER_CORE_TEXT_DOMAIN ),
                'filter_items_list'     => __( 'Filter items list', XRIVER_CORE_TEXT_DOMAIN ),
            ];
            $args = [
                'label'               => __( 'Mega Menu', XRIVER_CORE_TEXT_DOMAIN ),
                'labels'              => $labels,
    ...
    function edit_nav_menu_walker( $walker, $menu_id ) {
        if ( !class_exists( 'Alpha_Mega_Menu_Edit_Walker' ) ) {
            global $extra_menu_custom;
            $extra_menu_custom = $this->menu_meta_extra;
            require_once XRIVER_CORE_DIR . 'classes/class-mega-menu-edit.php';
        }

        return 'Alpha_Mega_Menu_Edit_Walker';
    }
