                    ...
                    while ( have_posts() ) :
                        ...
                        <div class="blog-post-wrap ">
                            <article class="post-details">
                                ...
                                <h2><?php the_title();?></h2>
                                <ul class="post-meta meta-bottom-border post-meta--4 style-2 meta-bottom-border ul_li">
                                ...
                                <!-- <div class="post-tags-share mt-20 mb-55">
                                    <?php 
                                    // if (true == cs_get_option('blog_single_bottom_tag_switcher')): ?>
                                    <div class="tags d-flex align-items-center mt-30">
                                        <ul class="list-unstyled ul_li">
                                            <?php 
                                            // magezix_entry_footer();?>
                                        </ul>
                                    </div>
                                    <?php 
                                // endif; ?>
                                    <?php 
                                    // if (true == cs_get_option('blog_single_bottom_social_icon_switcher')): ?>
                                        <?php
