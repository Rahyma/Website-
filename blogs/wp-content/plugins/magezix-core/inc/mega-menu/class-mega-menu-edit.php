...
//    private $extra_menu= $extra_menu_custom;
    ...
    <?php if (0 === $depth && $check_mega && $enable_megamenu === true) : ?>
        <p class="description description-wide">
            <label for="edit-menu-item-ct-megaprofile-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('Select Mega Menu', 'magezix-core'); ?><br/>
                <select id="edit-menu-item-ct-megaprofile-<?php echo esc_attr($item_id); ?>" class="widefat"
                    ...
                    <option value="0"><?php esc_html_e('None', 'magezix-core') ?></option>
                    <?php
                    $r = $this->walker_args;
    ...
    <?php if ($enable_ongpage_option && 0 === $depth) : ?>
        ...
        <p class="description description-wide">
            <label for="menu-item-ct-custom-class-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('Custom class', 'magezix-core'); ?><br/>
                <input type="text" min="0" id="menu-item-ct-custom-class-<?php echo esc_attr($item_id); ?>"
                        class="widefat menu-item-ct-custom-class"
                        name="menu-item-ct-custom-class[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr($item->ct_custom_class); ?>" />
            </label>
        </p>
    <?php endif;
