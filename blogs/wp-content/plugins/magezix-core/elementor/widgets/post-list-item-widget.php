...
class magezix_post_list extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post List', 'magezix-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'layout_style',
			[
				'label' => esc_html__( 'List Style', 'magezix-core' ),
				'type' => Controls_Manager::SELECT2,
				'default' => 'style_1',
				'options' => [
					'style_1'  => esc_html__( 'List Style 1', 'magezix-core' ),
					'style_2'  => esc_html__( 'List Style 2', 'magezix-core' ),
					'style_3'  => esc_html__( 'List Style 3', 'magezix-core' ),
					'style_4'  => esc_html__( 'List Style 4', 'magezix-core' ),
					'style_5'  => esc_html__( 'List Style 5', 'magezix-core' ),
					'style_6'  => esc_html__( 'List Style 6', 'magezix-core' ),
					'style_7'  => esc_html__( 'List Style 7', 'magezix-core' ),
					'style_8'  => esc_html__( 'List Style 8', 'magezix-core' ),
					'style_9'  => esc_html__( 'List Style 9', 'magezix-core' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .tx-post__category-item .post-thumb img' => 'height: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			'post_readmore_btn', [
				'label'       => esc_html__( 'Post Readmore Button', 'magezix-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => esc_html__( 'Read More', 'magezix-core' ),
				'label_block' => true,
				'condition' => ['layout_style' => 'style_4'],
			]
		);
    ...
    ?>
		...
		<?php 
			if('style_1' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-1.php';
			}elseif('style_2' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-2.php';
			}elseif('style_3' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-3.php';
			}elseif('style_4' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-4.php';
			}elseif('style_5' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-5.php';
			}elseif('style_6' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-6.php';
			}elseif('style_7' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-7.php';
			}elseif('style_8' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-8.php';
			}elseif('style_9' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/list-9.php';
			}else{
				require dirname( __FILE__ ) . '/views/list-1.php';
			}
		?>
...
Plugin::instance()->widgets_manager->register( new magezix_post_list() );