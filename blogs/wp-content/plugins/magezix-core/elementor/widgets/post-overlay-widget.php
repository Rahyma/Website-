...
class magezix_post_overlay extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Overlay', 'magezix-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'layout_style',
			[
				'label' => esc_html__( 'Overlay Style', 'magezix-core' ),
				'type' => Controls_Manager::SELECT2,
				'default' => 'style_1',
				'options' => [
					'style_1'  => esc_html__( 'Overlay Style 1', 'magezix-core' ),
					'style_2'  => esc_html__( 'Overlay Style 2', 'magezix-core' ),
					'style_3'  => esc_html__( 'Overlay Style 3', 'magezix-core' ),
					'style_4'  => esc_html__( 'Overlay Style 4', 'magezix-core' ),
					'style_5'  => esc_html__( 'Overlay Style 5', 'magezix-core' ),
					'style_6'  => esc_html__( 'Overlay Style 6', 'magezix-core' ),
					'style_7'  => esc_html__( 'Overlay Style 7', 'magezix-core' ),
					'style_8'  => esc_html__( 'Overlay Style 8', 'magezix-core' ),
					'style_9'  => esc_html__( 'Overlay Style 9', 'magezix-core' ),
				],
			]
		);
		...
		$this->add_control(
			'readmore_text',
			[
				'label'        => esc_html__( 'Post Readmore Text', 'magezix-core' ),
				'type'         =>Controls_Manager::TEXT,
				'default'      =>'Read More',
				'layout_style' => ['layout_style' => 'style_3'],
			]			
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .post-thumb.hxl-590 img' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tx-post.tx-post-overly.tx-post-overly--sm .post-thumb.mzx-post__item img' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .country-news .post-thumb.mzx-post__item img' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .featured__post-single .post-thumb img' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tx-post .post-thumb img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
    ...
    ?>
		<?php 
			if('style_1' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-1.php';
			}elseif('style_2' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-2.php';
			}elseif('style_3' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-3.php';
			}elseif('style_4' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-4.php';
			}elseif('style_5' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-5.php';
			}elseif('style_6' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-6.php';
			}elseif('style_7' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-7.php';
			}elseif('style_8' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-8.php';
			}elseif('style_9' == $settings['layout_style']){
				require dirname( __FILE__ ) . '/views/post-overlay-9.php';
			}else{
				require dirname( __FILE__ ) . '/views/post-overlay-1.php';
			}
		?>
...
Plugin::instance()->widgets_manager->register( new magezix_post_overlay() );