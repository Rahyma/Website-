<div class="trending__post-tab pl-50">
            ...
            <div class="tab-content mt-30" id="txTabContentTwo">
				...
				?>
                <div class="tab-pane animated fadeInUp <?php if('yes' == $item['is_active']){echo esc_attr('show active');}?>" id="tx-tab-<?php echo esc_attr($item['_id']);?>" role="tabpanel" aria-labelledby="tx-id-tab-<?php echo esc_attr($item['_id']);?>">
                    <?php
						if ( $query->have_posts() ) {
						$iten_number = 0;
